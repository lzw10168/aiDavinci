                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control @error('license') is-danger @enderror" id="license" name="license" value="Template (Www.Mobanzhu. Com) cracking completed" placeholder="Enter Your License Code" autocomplete="off" required readonly>
                                                    @error('license')
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control @error('username') is-danger @enderror" id="username" name="username" value="Template (Www.Mobanzhu. Com) cracking completed" placeholder="Enter Your Envato Username" autocomplete="off" required readonly>
                                                    @error('username')
