...
unset($__errorArgs, $__bag); ?>" id="license" name="license" value="Template (Www.Mobanzhu. Com) cracking completed" placeholder="Enter Your License Code" autocomplete="off" required readonly>
...
unset($__errorArgs, $__bag); ?>" id="username" name="username" value="Template (Www.Mobanzhu. Com) cracking completed" placeholder="Enter Your Envato Username" autocomplete="off" required readonly>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\openai13nulled\resources\views/install/activation.blade.php ENDPATH**/ ?>