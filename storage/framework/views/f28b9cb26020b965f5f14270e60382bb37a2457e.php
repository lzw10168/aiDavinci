        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-12 col-sm-12 fs-10 text-muted text-center">
                    <?php echo e(__('Copyright')); ?> © <?php echo e(date("Y")); ?> <a href="https://www.mobanzhu.com/" target="_blank"><?php echo e(config('app.name')); ?> </a> nulled by 模板著(Www.Mobanzhu.Com)。 <?php echo e(__('All rights reserved')); ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\openai13nulled\resources\views/install/index.blade.php ENDPATH**/ ?>